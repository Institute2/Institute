$(function(){
	...
	$('.modify').on('click', function(event) {
		...
		$.post(	'modifyDoingProject.do', readyData,  function(res) {
			alert(res.msg);  
			location.reload();
		});
	});
	$('.add').on('click', function(event) {
		...
		$.post(	'addDoingProject.do', readyData,  function(res) {
			alert(res.msg);  
			location.reload();
		});
	});
	$('.validate').on('click', function(event) {
		...
		$.post(	'validate.do', readyData,  function(res) {
			alert(res.msg);  
			location.reload();
		});
	});
	$('.del').on('click', function(event) {
		...
		$.post(	'delDoingProject.do', readyData,  function(res) {
			alert(res.msg);  
			location.reload();
		});
	});
