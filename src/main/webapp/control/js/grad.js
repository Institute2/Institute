$(function(){
	...
	$('.modify').on('click', function(event) {
		...
		if(name.val()=="" || zhiwu.val()=="" || whereabout.val()=="" || jianjie.val()=="" ||grade.val()==""){
			alert("有值为空！");
			return false;
		}
		var readyData = {
		...
		if(readyData.name==null && readyData.zhiwu==null && readyData.whereabout==null && readyData.jianjie==null &&readyData.grade==null){
			alert("没有修改,不用保存！");
			return false;
		}
